...
class RestaurantsItemsScreen extends StatelessWidget {
  const RestaurantsItemsScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    RestaurantsControllerImp restaurantsController =
                          ...
                          child: Stack(
                            ...
                            children: [
                              Positioned(
                                top: 0.h,
                                child: Hero(
                                  tag: controller.restaurants[myServices
                                          .sharedPreferences
                                          .getInt("restaurants_index")!]
                                      ['restaurants_id'],
                                  child: Container(
                                    width: 100.w,
                                    height: 27.h,
                                    decoration: BoxDecoration(
                                      ...
                                      image: NetworkImage(
                                          '${AppLink.restaurants_image}/${controller.restaurants[myServices.sharedPreferences.getInt("restaurants_index")!]['restaurants_background_image']}'),
                                      fit: BoxFit.fill,
                                    )),
                                  ),
                                ),
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: NetworkImage(
                                          '${AppLink.restaurants_image}/${controller.restaurants[myServices.sharedPreferences.getInt("restaurants_index")!]['restaurants_logo']}'),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
                                ),
                              ...
                              Positioned(
                                top: 26.h,
                                child: Text(
                                  '${myServices.sharedPreferences.getString("restaurants_name")}',
                                  style: TextStyle(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Transform.translate(
                                      ...
                                      child: Text(
                                        '${controller.restaurants[myServices.sharedPreferences.getInt("restaurants_index")!]['restaurants_rating']}',
                                        style: TextStyle(
                                          color: AppColor.grey,
                                          fontFamily: 'ElMessiri',
                                          fontSize: 10.sp,
                              ...
                              Positioned(
                                top: 30.h,
                                child: Text(
                                  '${controller.restaurants[myServices.sharedPreferences.getInt("restaurants_index")!]['restaurants_type']}',
                                  style: TextStyle(
                                      color: AppColor.grey,
                                      fontFamily: 'ElMessiri',
                                      fontSize: 11.sp),
                              ...
                              Positioned(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    myServices.sharedPreferences.getInt("restaurants_index")!]
                                    ['restaurants_is24'] ==
                                        1
                                        ? Text(
                                      '24/24',
                                      ...
                                      '${controller.formatTime(controller.restaurants[myServices.sharedPreferences.getInt("restaurants_index")!]['restaurants_open'])} - ${controller.formatTime(controller.restaurants[myServices.sharedPreferences.getInt("restaurants_index")!]['restaurants_close'])}',
                                      textDirection: TextDirection.rtl,
                                      style: TextStyle(
                                        color: AppColor.grey,
                                        fontFamily: 'ElMessiri',
                              ...
                              controller.restaurants[myServices
                                              .sharedPreferences
                                              .getInt("restaurants_index")!]
                                          ['restaurants_is24'] ==
                                      1
