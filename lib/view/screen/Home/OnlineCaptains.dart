...
class OnlineCaptains extends StatelessWidget {
  const OnlineCaptains({super.key});
        ...
        body: GetBuilder<CaptainControllerImp>(
          builder: (controller) => HandlingDataRequest(
            ...
            widget: Container(
              width: 100.w,
              height: 100.h,
              child: controller.online_captains.isEmpty
                  ? RefreshIndicator(
                onRefresh: ()async{
                ...
                child: Directionality(
                    ...
                    child: ListView.builder(
                      itemCount: controller.online_captains.length,
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                controller.online_captains[index]['delivery_online']==1 ?  Padding(
                                  padding: const EdgeInsets.all(18.0),
                                  child: Row(
                                    children: [

                                      Icon(Icons.motion_photos_on_sharp,color: Colors.green,size: 10.sp,),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Text(
                                          '${controller.online_captains[index]
                                          ['delivery_name']}',
                                          style: TextStyle(
                                            fontSize: 12.sp,
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            IconButton(onPressed: (){
                                              controller.makeCall(controller.online_captains[index]['delivery_phone']);
                                            }, icon: Icon(Icons.call), color: AppColor.secondaryColor,),

                                            SizedBox(width: 1.w),
                                            Text(
                                              '${controller.online_captains[index]['delivery_phone']}',
                                              style: TextStyle(
                                                fontSize: 12.sp,
                                                color: Colors.black26,
                                                fontFamily: 'Cairo',
